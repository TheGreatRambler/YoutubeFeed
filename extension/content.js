	...
	function start () {
		...
		setTimeout (function () {
			...
			var looper1 = setInterval (function () {
				if (possibleProfileButtons[possibleProfileButtons.length - 1]) {
		...
		Object.defineProperty(window.Image.prototype, "onabort", {
			get: function () {
				return this.innerImage.onabort;
			},
			set: function (source) {
				this.innerImage.onabort = source;
			}
		});

		Object.defineProperty(window.Image.prototype, "ontimeout", {
			get: function () {
				return this.innerImage.ontimeout;
			},
			set: function (source) {
				this.innerImage.ontimeout = source;
			}
		});

		var oldLocation = "";
		var mainLooper  = setInterval (function () {
            ...
            if (oldLocation != window.location.href) {
                if (oldLocation != "" && window.location.href.includes("youtube.com/watch?")) {
                    // This site is glitchy and confusing
                ...
                if (window.location.href.includes("youtube.com/watch?")) {
                    ...
                    var looper1 = setInterval (function () {
                        if (document.getElementsByClassName("style-scope ytd-subscribe-button-renderer")[0]) {
                            clearInterval (looper1);
